...
# making a bar chart of how the various categories relates with sales
with col1:
    st.header("category wise sales")
    fig= px.bar(category_df, x= "Category", y="Sales", text=['${:,.2f}'.format(x) for x in category_df["Sales"]], template="seaborn")
    st.plotly_chart(fig,use_container_width=True, height=200)

# making a piechart of how various regions relates with sales
with col2:
...
# Display data of category wise sales
with col1:
...
# Display data of Region wise sales
with col2:
